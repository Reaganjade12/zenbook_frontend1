...
const staffAPI = {
    ...
    async createUser(userData) {
        return await apiClient.post('/staff/users', userData);
    },
    ...
    async updateUser(id, userData) {
        return await apiClient.put(`/staff/users/${id}`, userData);
    },
...
const superAdminAPI = {
     ...
     */
    async getAdmins() {
        return await apiClient.get('/super-admin/admins');
    },
    ...
    async createAdmin(adminData) {
        return await apiClient.post('/super-admin/admins', adminData);
    },
    ...
    async updateAdmin(id, adminData) {
        return await apiClient.put(`/super-admin/admins/${id}`, adminData);
    },
    ...
    async deleteAdmin(id) {
        return await apiClient.delete(`/super-admin/admins/${id}`);
    },
};
